...
const Loading = () => {
    return (
        ...
        >
            ...
            <rect
                transform="matrix(.707 .707 -.707 .707 16.4 -19.6)"
                height="9.89"
                width="6.38"
                y="5.02"
                x="28.6"
            />
            <rect
                transform="matrix(.707 .707 -.707 .707 25.4 2.26)"
                height="9.89"
                width="6.38"
                y="26.8"
                x="6.77"
            ...
            <rect
                transform="matrix(-.707 .707 -.707 -.707 76.7 31.8)"
                height="9.89"
                width="6.38"
                y="26.8"
                x="28.6"
            />
            <rect
                transform="matrix(-.707 .707 -.707 -.707 24.1 9.96)"
                height="9.89"
                width="6.38"
                y="5.02"
                x="6.77"
